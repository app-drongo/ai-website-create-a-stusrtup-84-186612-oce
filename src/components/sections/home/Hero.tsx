        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="flex justify-center mb-8">
            ...
            >
              ...
              Revolutionary SaaS Platform Now Live
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Transform your workflow with intelligent automation that learns from your business
              patterns. Increase productivity by 300% while reducing operational costs.
            </p>
          ...
          <div className="mt-16 relative">
            <div className="relative mx-auto max-w-4xl">
                ...
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-4 grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-secondary/20 rounded-lg p-3">
                      ...
                      <div className="h-1 bg-secondary/30 rounded w-4/5"></div>
                    </div>
                  </div>
              ...
              {/* Floating Metrics */}
              <div className="absolute -top-4 -left-4 bg-card border rounded-lg p-2 shadow-lg">
              ...
              <div className="absolute -bottom-4 -right-4 bg-card border rounded-lg p-2 shadow-lg">
                ...
                <div className="text-sm font-bold text-accent">15hrs/week</div>
              </div>
              <div className="absolute top-1/2 -right-8 bg-card border rounded-lg p-2 shadow-lg">
                <div className="text-xs text-muted-foreground">Accuracy</div>
                <div className="text-sm font-bold text-secondary">99.7%</div>
              </div>
            </div>
          </div>
        </div>
